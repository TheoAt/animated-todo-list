...
import Animated, { Easing, useAnimatedStyle, useSharedValue, withTiming, withSequence, withDelay, interpolateColor } from 'react-native-reanimated'
    ...
    return(
        <Pressable onPress={onPress}>
            <AnimatedHStack alignItems='center' style={[hstackAnimatedStyles]}>
                <AnimatedText fontSize={18} noOfLines={1} isTruncated px={1} style={[textColorAnimatedStyles]}>
                    {children}
                </AnimatedText>
